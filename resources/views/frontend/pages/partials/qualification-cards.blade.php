{{-- @forelse($courses as $course)
    <div class="qualification-card bg-white border border-slate-200 transition-all duration-300 rounded-md">
        ...
        <div class="p-6 space-y-4">
            <span
                class="text-caption text-xs text-[#02A8FF] bg-[#02A8FF]/10 font-semibold px-2 py-1 uppercase rounded">{{ $course['industry'] }}</span>
            ...
            <div class="pt-4 border-t border-slate-100 flex items-center justify-between gap-6">
                <a href="{{ route('qualifications.details', $course['slug']) }}"
                    class="flex justify-center items-center w-1/2 bg-white border border-[#02A8FF] text-[#02A8FF] hover:bg-[#02A8FF] hover:text-white rounded py-1.5 font-medium text-sm transition-transform">View
                    Details</a>
                <button data-open-apply-modal
