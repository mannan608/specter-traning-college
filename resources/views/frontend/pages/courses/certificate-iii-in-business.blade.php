                    ...
                    <section id="overview">
                        ...
                        <div class="prose prose-slate max-w-none">
                            <p
                               ...
                               The Certificate III in Business provides learners with practical workplace skills and foundational business knowledge required in modern office environments. This qualification prepares students for administrative, customer service, and operational support roles across various industries.
                            </p>
                        </div>
                    </section>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <div
                                ...
                                <ul class="space-y-2 sm:space-y-3 font-body-md text-brand-500-variant text-sm sm:text-base">
                                    ...
                                    <li class="flex items-start gap-2">
                                        <span class="material-symbols-outlined text-xs mt-1">check_circle</span>
                                        Business technology and digital applications
                                    </li>
                                    <li class="flex items-start gap-2">
                                        <span class="material-symbols-outlined text-xs mt-1">check_circle</span>
                                        Organising schedules and workplace tasks
                                    </li>
                                    <li class="flex items-start gap-2">
                                        <span class="material-symbols-outlined text-xs mt-1">check_circle</span>
                                        Customer service and business documentation
                                    </li>
                                    <li class="flex items-start gap-2">
                                        <span class="material-symbols-outlined text-xs mt-1">check_circle</span>
                            ...
                            <div class="flex-1">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                    ...
                                    <div
                                        class="flex items-center gap-3 bg-white p-3 sm:p-4 rounded border border-slate-200">
                                        <span class="material-symbols-outlined text-brand-500">badge</span>
                                        <span class="font-label-bold">Office Support Staff</span>
                                    </div>
                                    <div
                                        class="flex items-center gap-3 bg-white p-3 sm:p-4 rounded border border-slate-200">
                                        <span class="material-symbols-outlined text-brand-500">badge</span>
                    ...
                    <section id="development">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                            ...
                            <div
                                ...
                                <p class="font-body-md text-brand-500 text-sm sm:text-base">Work effectively within a team environment</p>
                            </div>
                        </div>
                    </section>
                        ...
                        <div class="space-y-3 sm:space-y-4">
                            <div
                                ...
                                <div class="flex items-center gap-3 sm:gap-4">
                                    ...
                                    <span class="text-base md:text-lg text-headline-md">Certificate IV in Business</span>
                                </div>
