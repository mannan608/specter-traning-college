                    ...
                    <section id="overview">
                        ...
                        <div class="prose prose-slate max-w-none">
                            <p
                                ...
                                This qualification provides the practical skills and knowledge required to work effectively in hospitality environments such as restaurants, hotels, cafés, and catering businesses.
                            </p>
                        </div>
                    </section>
                            ...
                            <div class="bg-slate-50 border border-slate-200 p-5 sm:p-6 lg:p-8 rounded">
                                ...
                                <ul class="space-y-2 sm:space-y-3 font-body-md text-brand-500-variant text-sm sm:text-base">
                                    <li class="flex items-start gap-2">
                                        ...
                                        Coffee preparation and barista skills
                                    </li>
                                    <li class="flex items-start gap-2">
                                        <span class="material-symbols-outlined text-xs mt-1">add_circle_outline</span>
                            ...
                            <div class="flex-1">
                              ...
                              <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                                <div class="flex items-center gap-3 bg-white p-3 sm:p-4 rounded border border-slate-200">
                                    ...
                                    <span class="font-label-bold">Hospitality Attendant</span>
                                </div>
                                <div class="flex items-center gap-3 bg-white p-3 sm:p-4 rounded border border-slate-200">
                                    <span class="material-symbols-outlined text-brand-500">restaurant</span>
                                    <span class="font-label-bold">Food and Beverage Assistant</span>
                                </div>
                                <div class="flex items-center gap-3 bg-white p-3 sm:p-4 rounded border border-slate-200">
                                    <span class="material-symbols-outlined text-brand-500">badge</span>
                                    <span class="font-label-bold">Café Attendant</span>
                                </div>
                                <div class="flex items-center gap-3 bg-white p-3 sm:p-4 rounded border border-slate-200">
                                    <span class="material-symbols-outlined text-brand-500">coffee</span>
                                    <span class="font-label-bold">Wait Staff</span>
                                </div>
                                <div class="flex items-center gap-3 bg-white p-3 sm:p-4 rounded border border-slate-200">
                                    <span class="material-symbols-outlined text-brand-500">groups</span>
                                    <span class="font-label-bold">Guest Service Assistant</span>
                                </div>
                            </div>
                            </div>
                            <div class="md:w-1/3">
                    ...
                    <section id="development">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                            <div class="flex items-center gap-4 bg-white p-4 sm:p-5 lg:p-6 border border-slate-200 rounded">
                                ...
                                <p class="font-body-md text-brand-500 text-sm sm:text-base">Deliver quality hospitality services</p>
                            </div>
                            ...
                            <div class="flex items-center gap-4 bg-white p-4 sm:p-5 lg:p-6 border border-slate-200 rounded">
                                ...
                                <p class="font-body-md text-brand-500 text-sm sm:text-base">Interact professionally with customers</p>
                            </div>
                            ...
                            <div class="flex items-center gap-4 bg-white p-4 sm:p-5 lg:p-6 border border-slate-200 rounded">
                                ...
                                <p class="font-body-md text-brand-500 text-sm sm:text-base">Follow food safety standards</p>
                            </div>
                            ...
                            <div class="flex items-center gap-4 bg-white p-4 sm:p-5 lg:p-6 border border-slate-200 rounded">
                                ...
                                <p class="font-body-md text-brand-500 text-sm sm:text-base">Work effectively in fast-paced environments</p>
                            </div>
                            ...
                            <div class="flex items-center gap-4 bg-white p-4 sm:p-5 lg:p-6 border border-slate-200 rounded">
                                ...
                                <p class="font-body-md text-brand-500 text-sm sm:text-base">Support hospitality operations efficiently</p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section id="industries">
                        ...
                        <div class="flex flex-wrap gap-2 sm:gap-3">
                            <span
                                ...
                                <span class="material-symbols-outlined text-sm">hotel</span> Restaurants
                            </span>
                            <span
                                class="bg-brand-500/10 px-4 sm:px-6 py-2 sm:py-3 rounded-full font-label-bold text-brand-500 flex items-center gap-2 text-sm">
                                <span class="material-symbols-outlined text-sm">restaurant</span> Hotels
                            </span>
                            <span
                                class="bg-brand-500/10 px-4 sm:px-6 py-2 sm:py-3 rounded-full font-label-bold text-brand-500 flex items-center gap-2 text-sm">
                                <span class="material-symbols-outlined text-sm">event</span> Cafés
                            </span>
                            <span
                                class="bg-brand-500/10 px-4 sm:px-6 py-2 sm:py-3 rounded-full font-label-bold text-brand-500 flex items-center gap-2 text-sm">
                                <span class="material-symbols-outlined text-sm">travel_explore</span> Catering Companies
                            </span>
                            <span
                                class="bg-brand-500/10 px-4 sm:px-6 py-2 sm:py-3 rounded-full font-label-bold text-brand-500 flex items-center gap-2 text-sm">
                                <span class="material-symbols-outlined text-sm">flatware</span> Tourism Businesses
                            </span>
                        </div>
                    </section>
                    <!-- Study Pathways -->
                        ...
                        <div class="space-y-3 sm:space-y-4">
                            <div
                                ...
                                <div class="flex items-center gap-3 sm:gap-4">
                                    ...
                                    <span class="text-base md:text-lg text-headline-md">Certificate IV in Hospitality</span>
                                </div>
                            ...
                            <div
                                ...
                                <div class="flex items-center gap-3 sm:gap-4">
                                    <span class="material-symbols-outlined text-brand-500">arrow_forward</span>
                                    <span class="text-base md:text-lg text-headline-md">Diploma of Hospitality Management</span>
                                </div>
