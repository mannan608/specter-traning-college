                    ...
                    <section id="overview">
                        ...
                        <div class="prose prose-slate max-w-none">
                            <p
                               ...
                               The Certificate III in Process Manufacturing provides technical and operational skills for individuals working in manufacturing and production industries.
                            </p>
                        </div>
                    </section>
                    ...
                    <section id="development">
                      ...
                      <div class="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                        ...
                        <div class="flex items-center gap-4 bg-white p-4 sm:p-5 lg:p-6 border border-slate-200 rounded">
                            ...
                            <p class="font-body-md text-brand-500 text-sm sm:text-base">Work effectively in production teams</p>
                        </div>
                    </div>
                    </section>
                    ...
                    <section id="industries">
                       ...
                       <div class="flex flex-wrap gap-2 sm:gap-3">
                            <span
                                ...
                                <span class="material-symbols-outlined text-sm">factory</span> Manufacturing Plants
                            </span>
                            <span
                                class="bg-brand-500/10 px-4 sm:px-6 py-2 sm:py-3 rounded-full font-label-bold text-brand-500 flex items-center gap-2 text-sm">
                                <span class="material-symbols-outlined text-sm">inventory_2</span> Food Processing
                            </span>
                            <span
                                class="bg-brand-500/10 px-4 sm:px-6 py-2 sm:py-3 rounded-full font-label-bold text-brand-500 flex items-center gap-2 text-sm">
                                <span class="material-symbols-outlined text-sm">deployed_code</span> Packaging Industries
                            </span>
                            <span
                                class="bg-brand-500/10 px-4 sm:px-6 py-2 sm:py-3 rounded-full font-label-bold text-brand-500 flex items-center gap-2 text-sm">
                                <span class="material-symbols-outlined text-sm">local_shipping</span> Warehousing and Logistics
                            </span>
                            <span
                                class="bg-brand-500/10 px-4 sm:px-6 py-2 sm:py-3 rounded-full font-label-bold text-brand-500 flex items-center gap-2 text-sm">
                                <span class="material-symbols-outlined text-sm">precision_manufacturing</span> Industrial Production Facilities
                            </span>
                        </div>
                    </section>
                    <!-- Study Pathways -->
                        ...
                        <div class="space-y-3 sm:space-y-4">
                            <div
                                ...
                                <div class="flex items-center gap-3 sm:gap-4">
                                    ...
                                    <span class="text-base md:text-lg text-headline-md">Certificate IV in Manufacturing</span>
                                </div>
                            ...
                            <div
                                ...
                                <div class="flex items-center gap-3 sm:gap-4">
                                    <span class="material-symbols-outlined text-brand-500">arrow_forward</span>
                                    <span class="text-base md:text-lg text-headline-md">Diploma of Manufacturing Technology</span>
                                </div>
