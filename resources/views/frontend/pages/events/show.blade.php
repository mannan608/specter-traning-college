    ...
    <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div class="lg:col-span-8">
                ...
                <article class="bg-white rounded-2xl shadow-sm border overflow-hidden event-content">
                    ...
                    <div class="p-4 md:p-6 lg:p-8">
                        ...
                        {{-- Content --}}
                        <div class="prose max-w-none event-content">
                            {!! $event->content !!}
                        </div>
                    ...
                    <div class="bg-white border rounded-2xl shadow-sm p-5">
                        ...
                        <div class="space-y-5">
                            ...
                            @forelse($latestEvents as $item)
                                ...
                                @php
                                    $thumb = $item->banner
                                        ? asset('storage/' . $item->banner)
                                        : asset('images/default-event.jpg');
                                @endphp

                                <a
                                    href="{{ route('event-details', $item->slug) }}"
